...
label_style = tk.Label (root, text = 'Style:',background = 'lightblue').grid(sticky = "W", row = 5, column = 0)
label_variety = tk.Label (root, text = 'Variety:',background = 'lightblue').grid(sticky = "W", row = 6, column = 0)
label_top5 = tk.Label (root, text = 'Top 5 words:',background = 'lightblue').grid(sticky = "W", row = 7, column = 0)
label_words = tk.Label (root, text = 'Mean number of words:',background = 'lightblue').grid(sticky = "W", row = 8, column = 0)
...
label_author = tk.Label (root, text = 'Probability of the same author:',background = 'lightblue').grid(sticky = "W", row = 13, column = 0)
label_plagiarism = tk.Label (root, text = 'Probability of plagiarism:',background = 'lightblue').grid(sticky = "W", row = 12, column = 0)
